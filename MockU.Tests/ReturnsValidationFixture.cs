...
*/
{
    ...
    {
        mock = new Mock<IType>();
        setup = mock.Setup(m => m.Method(It.IsAny<object>(), It.IsAny<object>()));
        setupNoArgs = mock.Setup(m => m.MethodNoArgs());
    }
    ...
    public void Returns_does_not_accept_delegate_without_return_value()
    {
        ...
        {
            setup.Returns(delegateWithoutReturnValue);
        });
    ...
    public void Returns_does_not_accept_delegate_with_wrong_return_type()
    {
        ...
        var ex = Record.Exception(() =>
        {
            setup.Returns(delegateWithWrongReturnType);
        });
    ...
    public void Returns_does_not_accept_delegate_with_wrong_parameter_count()
    {
        ...
        var ex = Record.Exception(() =>
        {
            setup.Returns(delegateWithWrongParameterCount);
        });
    ...
    public void Returns_does_not_accept_extension_method_with_wrong_parameter_count()
    {
        ...
        var ex = Record.Exception(() =>
        {
            setupNoArgs.Returns(delegateWithWrongParameterCount);
        });
