...
public class MatchFixture
{
    ...
    public class Equality
    {
        ...
        public void It_Is_with_equal_arguments_2()
        {
            ...
            var first = GetMatch(() => It.Is(comparison));
            var second = GetMatch(() => It.Is(comparison));
            Assert.Equal(first, second);
        }
    ...
    abstract class Order
    {
        ...
        {
            return Match.Create(order => order.MetricTons < 1000M, () => IsSmallRE());
        }
        ...
        {
            return Match.Create(order => order.MetricTons >= 1000M, () => IsLargeRE());
        }
        ...
        {
            return Match.Create(order => order.MetricTons < threshold, () => IsSmallerThanRE(threshold));
        }
        ...
        {
            return Match.Create(order => order.MetricTons < threshold, () => IsLargerThanRE(threshold));
        }

        public static Order PretendIsAny()
        {
            return Match.Create(order => false, () => It.IsAny<Order>());
        }
    }
}
