...
*/
{
    ...
    {
        mock = new Mock<Foo>();
        protectedMock = mock.Protected().As<Fooish>();
    }
    ...
    public void Setup_throws_ArgumentException_when_expression_contains_nonexistent_method()
    {
        var actual = Record.Exception(() =>
        {
            protectedMock.Setup(m => m.NonExistentMethod());
        });
    ...
    public void Setup_throws_ArgumentException_when_expression_contains_nonexistent_property()
    {
        var actual = Record.Exception(() =>
        {
            protectedMock.Setup(m => m.NonExistentProperty);
        });
    ...
    {
        var actual = Record.Exception(() => protectedMock.Setup<object>(null));
    ...
    public void Setup_can_setup_simple_method()
    {
        ...
        protectedMock.Setup(m => m.DoSomethingImpl()).Callback(() => doSomethingImplInvoked = true);
    ...
    {
        protectedMock.Setup(m => m.GetSomethingImpl()).Returns(() => 42);

        var actual = mock.Object.GetSomething();
    ...
    {
        bool doSomethingImplInvoked = false;
        protectedMock.Setup(m => m.DoSomethingImpl(1)).Callback(() => doSomethingImplInvoked = true);
    ...
    {
        bool doSomethingImplInvoked = false;
        protectedMock.Setup(m => m.DoSomethingImpl(It.Is<int>(i => i == 1))).Callback(() => doSomethingImplInvoked = true);
    ...
    {
        protectedMock.Setup(m => m.Nested.Method(1)).Returns(123);
    ...
    {
        protectedMock.SetupGet(m => m.ReadOnlyPropertyImpl).Returns(42);

        var actual = mock.Object.ReadOnlyProperty;
    ...
    {
        protectedMock.SetupGet(m => m.ReadWritePropertyImpl).Returns(42);

        var actual = mock.Object.ReadWriteProperty;
    ...
    {
        protectedMock.SetupGet(m => m.Nested.Value).Returns(42);
    ...
    {
        protectedMock.SetupGet(m => m.VirtualGet).Returns(42);
    ...
    {
        protectedMock.SetupProperty(m => m.ReadWritePropertyImpl, 42);

        var actualBeforeSetting = mock.Object.ReadWriteProperty;
        mock.Object.ReadWriteProperty = 17;
        var actualAfterSetting = mock.Object.ReadWriteProperty;
    ...
    public void SetupProperty_cannot_setup_readonly_property()
    {
        ...
        {
            protectedMock.SetupProperty(m => m.ReadOnlyPropertyImpl);
        });
    ...
    {
        protectedMock.SetupSequence(m => m.ReadOnlyPropertyImpl)
            .Returns(1)
            .Throws(new InvalidOperationException())
            .Returns(3);

        var actual = new List<int>();
        actual.Add(mock.Object.ReadOnlyProperty);
        var exception = Record.Exception(() =>
        {
            actual.Add(mock.Object.ReadOnlyProperty);
        });
    ...
    {
        protectedMock.SetupSequence(m => m.DoSomethingImpl())
            .Pass()
            .Pass().
            Throws(new InvalidOperationException());
    ...
    {
        protectedMock.SetupSet(fish => fish.ReadWritePropertyImpl = 999).Throws(ExpectedException.Instance);
    ...
    {
        int value = 0;
        protectedMock.SetupSet<int>(fish => fish.ReadWritePropertyImpl = 999).Callback(i => value = i);
    ...
    {
        protectedMock.SetupSet(f => f.Nested.Value = 999).Throws(ExpectedException.Instance);
    ...
    {
        protectedMock.SetupSet(m => m.VirtualSet = 999).Throws(new ExpectedException());
    ...
    public void Verify_can_verify_method_invocations()
    {
        ...
        protectedMock.Verify(m => m.DoSomethingImpl());
    }
    ...
    public void Verify_can_verify_method_invocations_times()
    {
        ...
        protectedMock.Verify(m => m.DoSomethingImpl(), Times.Exactly(3));
    }
    ...
    public void Verify_includes_failure_message_in_exception()
    {
        ...
        var exception = Record.Exception(() =>
        {
            protectedMock.Verify(m => m.DoSomethingImpl(), Times.Exactly(3), "Wasn't called three times.");
        });
    ...
    {
        var _ = mock.Object.ReadOnlyProperty;

        protectedMock.VerifyGet(m => m.ReadOnlyPropertyImpl);
    }
    ...
    public void VerifyGet_throws_if_property_query_not_occurred()
    {
        ...
        var exception = Record.Exception(() =>
        {
            protectedMock.VerifyGet(m => m.ReadOnlyPropertyImpl, Times.AtLeast(2));
        });
    }
    ...
    public void VerifyGet_includes_failure_message_in_exception()
    {
        var exception = Record.Exception(() =>
        {
            protectedMock.VerifyGet(m => m.ReadOnlyPropertyImpl, Times.Once(), "Was not queried.");
        });
    ...
    public abstract class Foo
    {
        ...
        public int ReadOnlyProperty => ReadOnlyPropertyImpl;

        public int ReadWriteProperty
        {
            get => ReadWritePropertyImpl;
            set => ReadWritePropertyImpl = value;
        }
