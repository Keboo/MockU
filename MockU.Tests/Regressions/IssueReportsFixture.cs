...
namespace MockU.Tests.Regressions
{
        ...
        public class Issue175
        {
            ...
            public class Frobber
            {
                ...
                public Frobber(params ISharedType[] inputs)
                {
                    ...
                    internalStore = new List<ISharedType>(inputs);
                }
                ...
                public bool WasExtendedType
                {
                    get
                    {
                        return internalStore.First() is IExtendedType;
                    }
                }
                ...
                public int ExtendedTypeValue
                {
                    get
                    {
                        return ((IExtendedType)internalStore.First()).ExtendedValue;
                    }
                }
            }
        ...
        */
        ...
        public class Issue296
        {
            ...
            public void Can_subscribe_to_and_raise_abstract_class_event_when_CallBase_true()
            {
                ...
                mock.Object.SomethingChanged += (sender, e) =>
                {
    ...
    public sealed class Issue526
    {
        ...
        public class Issue652
        {
            ...
            {
                Mock<IMyInterface> mock = new MockU.Mock<IMyInterface>();
        ...
        public class Issue657
        {
            ...
            public void Test()
            {
                var mock = new MockU.Mock<Contract>() { CallBase = true };
...
#pragma warning restore CS0067
...

            {
                ...
                event Action IA.E
                {
                    add => ae = (Action)Delegate.Combine(ae, value);
                    remove => ae = (Action)Delegate.Combine(ae, value);
                }

                event Action IB.E
                {
                    add => be = (Action)Delegate.Combine(be, value);
                    remove => be = (Action)Delegate.Combine(be, value);
                }

                public void RaiseAE() => ae?.Invoke();

                public void RaiseBE() => be?.Invoke();
            }
        }
        ...
        */
        {
            ...
            public void DateTimeOffset()
            {
                ...
                serviceMock.Setup(s => s.GetDataList(It.IsAny<DateTimeOffset>())).Returns(data);
        ...
        public class Issue903
        {
            ...
            public void Bool_method_was_setup_first__when_bool_method_invoked__bool_method_setup_should_be_matched()
            {
                ...
                SetupBoolMethod(() => boolMethodInvoked = true);
                SetupIntMethod(() => throw new Exception("Wrong method called."));
            ...
            public void Int_method_was_setup_last__when_int_method_invoked__int_method_setup_should_be_matched()
            {
                ...
                SetupBoolMethod(() => throw new Exception("Wrong method called."));
                SetupIntMethod(() => intMethodInvoked = true);
            ...
            */
            {
                ...
                {
                    myHidingEvents = theHidingEvents;
                    myHidingEvents.Created += HidingEventsOnCreated;
        ...
        public class Issue1225
        {
            ...
            {
                void Transmit(nint ptr, byte[] send, byte[] recv);
            }

            public class MyImpl : IHardware
            {
                public void Transmit(nint ptr, byte[] send, byte[] recv)
                {
            ...
            public void Pass_byte_array_directly()
            {
                ...
                hwMock.Setup(m => m.Transmit(It.IsAny<nint>(), It.IsAny<byte[]>(), It.IsAny<byte[]>()));

                DoWork(hwMock.Object, new byte[] { 1, 2, 3 });

                hwMock.Verify(m => m.Transmit(1, new byte[] { 1, 2, 3 }, It.IsAny<byte[]>()));
            }
            ...
            public void Pass_byte_array_indirectly_via_method_call()
            {
                ...
                hwMock.Verify(m => m.Transmit(1, Convert.FromBase64String(inputAsString), It.IsAny<byte[]>()));
            }
        }
        ...
        public class Issue48
        {
            ...
            public void ExpectsOnIndexer()
            {
                ...
                Assert.Equal(default, mock.Object[2]);
            }
    ...
    public class _160
    {
        ...
        public class _204
        {
            ...
            public void Test()
            {
                ...
                mock.Verify(x => x.Select(It.IsAny<Expression<Func<User, bool>>>()), Times.Exactly(2));
            }
