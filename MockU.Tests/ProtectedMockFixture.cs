...
public partial class ProtectedMockFixture
{
    ...
    public void SetupAllowsProtectedMethodWithNullableParameters()
    {
        ...
        Assert.Equal(expectedOutput, mock.Object.DoProtectedWithGenericParam(input));
    }
    ...
    public void ResolveOverloads()
    {
        ...
        Assert.Equal("4", mock.Object.ExecuteDoReturn(1, "2"));
    ...
    public class FooBase
    {
        ...
        {
            return ProtectedWithNullableIntParam(value);
        }
