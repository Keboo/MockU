...
public partial class Mock<T> : Mock, IMock<T> where T : class
{
    ...
    private void InitializeInstance()
    {
        ...
        var additionalInterfaceCount = AdditionalInterfaces.Count;
        var interfaces = new Type[1 + additionalInterfaceCount];
        interfaces[0] = typeof(IMocked<T>);
        AdditionalInterfaces.CopyTo(0, interfaces, 1, additionalInterfaceCount);

        instance = (T)ProxyFactory.Instance.CreateProxy(
            typeof(T),
            this,
            interfaces,
    ...
    public override Mock<TInterface> As<TInterface>()
    {
        ...
        if (IsObjectInitialized && ImplementsInterface(interfaceType) == false)
        {
            throw new InvalidOperationException(Resources.AlreadyInitialized);
        }

        if (AdditionalInterfaces.Contains(interfaceType) == false)
        {
            ...
            AdditionalInterfaces.Add(interfaceType);
        }
    ...
    {
        var setup = Setup(this, expression, null);
    ...
    {
        var setup = SetupGet(this, expression, null);
    ...
    public ISetupSetter<T, TProperty> SetupSet<TProperty>(Action<T> setterExpression)
    {
        ...
        var expression = ExpressionReconstructor.Instance.ReconstructExpression(setterExpression, ConstructorArguments);

        var setup = SetupSet(this, expression, condition: null);
    ...
    public ISetup<T> SetupAdd(Action<T> addExpression)
    {
        ...
        var expression = ExpressionReconstructor.Instance.ReconstructExpression(addExpression, ConstructorArguments);

        var setup = SetupAdd(this, expression, condition: null);
        return new VoidSetupPhrase<T>(setup);
    }
    ...
    public ISetup<T> SetupRemove(Action<T> removeExpression)
    {
        ...
        var expression = ExpressionReconstructor.Instance.ReconstructExpression(removeExpression, ConstructorArguments);

        var setup = SetupRemove(this, expression, condition: null);
        return new VoidSetupPhrase<T>(setup);
    }
    ...
    {
        return SetupProperty(property, default);
    }
    ...
    {
        var setup = SetupSequence(this, expression);
    ...
    {
        VerifyGet(this, expression, Times.AtLeastOnce(), null);
    }
    ...
    {
        VerifyGet(this, expression, Times.AtLeastOnce(), failMessage);
    }
    ...
    public void VerifySet(Action<T> setterExpression)
    {
        ...
        var expression = ExpressionReconstructor.Instance.ReconstructExpression(setterExpression, ConstructorArguments);
        VerifySet(this, expression, Times.AtLeastOnce(), null);
    }
    ...
    public void VerifySet(Action<T> setterExpression, Times times)
    {
        ...
        var expression = ExpressionReconstructor.Instance.ReconstructExpression(setterExpression, ConstructorArguments);
        VerifySet(this, expression, times, null);
    }
    ...
    public void VerifySet(Action<T> setterExpression, string failMessage)
    {
        ...
        var expression = ExpressionReconstructor.Instance.ReconstructExpression(setterExpression, ConstructorArguments);
        VerifySet(this, expression, Times.AtLeastOnce(), failMessage);
    }
    ...
    public void VerifySet(Action<T> setterExpression, Times times, string failMessage)
    {
        ...
        var expression = ExpressionReconstructor.Instance.ReconstructExpression(setterExpression, ConstructorArguments);
        VerifySet(this, expression, times, failMessage);
    }
    ...
    public void VerifyAdd(Action<T> addExpression)
    {
        ...
        var expression = ExpressionReconstructor.Instance.ReconstructExpression(addExpression, ConstructorArguments);
        VerifyAdd(this, expression, Times.AtLeastOnce(), null);
    }
    ...
    public void VerifyAdd(Action<T> addExpression, Times times)
    {
        ...
        var expression = ExpressionReconstructor.Instance.ReconstructExpression(addExpression, ConstructorArguments);
        VerifyAdd(this, expression, times, null);
    }
    ...
    public void VerifyAdd(Action<T> addExpression, string failMessage)
    {
        ...
        var expression = ExpressionReconstructor.Instance.ReconstructExpression(addExpression, ConstructorArguments);
        VerifyAdd(this, expression, Times.AtLeastOnce(), failMessage);
    }
    ...
    public void VerifyAdd(Action<T> addExpression, Times times, string failMessage)
    {
        ...
        var expression = ExpressionReconstructor.Instance.ReconstructExpression(addExpression, ConstructorArguments);
        VerifyAdd(this, expression, times, failMessage);
    }
    ...
    public void VerifyRemove(Action<T> removeExpression)
    {
        ...
        var expression = ExpressionReconstructor.Instance.ReconstructExpression(removeExpression, ConstructorArguments);
        VerifyRemove(this, expression, Times.AtLeastOnce(), null);
    }
    ...
    public void VerifyRemove(Action<T> removeExpression, Times times)
    {
        ...
        var expression = ExpressionReconstructor.Instance.ReconstructExpression(removeExpression, ConstructorArguments);
        VerifyRemove(this, expression, times, null);
    }
    ...
    public void VerifyRemove(Action<T> removeExpression, string failMessage)
    {
        ...
        var expression = ExpressionReconstructor.Instance.ReconstructExpression(removeExpression, ConstructorArguments);
        VerifyRemove(this, expression, Times.AtLeastOnce(), failMessage);
    }
    ...
    public void VerifyRemove(Action<T> removeExpression, Times times, string failMessage)
    {
        ...
        var expression = ExpressionReconstructor.Instance.ReconstructExpression(removeExpression, ConstructorArguments);
        VerifyRemove(this, expression, times, failMessage);
    }
    ...
    {
        RaiseEvent(this, eventExpression, args);
    }
    ...
    {
        return RaiseEventAsync(this, eventExpression, args);
    }
